...
class NiceSelect {
  ...
  */
  ...
  /*
     PRIVATE FUNCTIONS
  */
  _create(initial=true) {
    this.data ? this._processData(this.data) : this._extractData(initial);
    this.el.classList.remove('hidden-select');
